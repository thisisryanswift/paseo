...
| [docs/external-opencode-server-design.md](docs/external-opencode-server-design.md) | External OpenCode ownership, authentication, session identity, and native-session inbox behavior                               |
| [docs/reef-upgrades.md](docs/reef-upgrades.md)                                     | Reef host procedure for upgrading the Paseo fork and independently supervised OpenCode service                                 |
